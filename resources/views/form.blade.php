...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/trubros.css') }}">
    <!-- Leaflet CSS -->
    ...
    <script>
        ...
        function mostrarActividad() {
            var actividad = document.getElementById("dimension_programa").value; 
            var facilitadoresDiv = document.getElementById("facilitadores"); 
            var colectivosDiv = document.getElementById("colectivos"); 
            var usuariosDiv = document.getElementById("usuarios");
            var beneficiarioDiv = document.getElementById("beneficiario");

            facilitadoresDiv.style.display = actividad === 'facilitadores' ? 'block' : 'none'; 
            colectivosDiv.style.display = actividad === 'colectivos' ? 'block' : 'none'; 
            usuariosDiv.style.display = actividad === 'usuarios' ? 'block' : 'none';
            beneficiarioDiv.style.display = actividad === 'beneficiario' ? 'block' : 'none';
        }
...
<body>
    <div class="container">
        <form class="miFormulario" action="{{ route('formulario.submit') }}" method="POST">
            @csrf
            <div class="row">
                <div class="column">
                    <h2 class="title">Cuidar y ser cuidado para el bienestar 2025</h2>
                    <div class="form-group">
                        <label for="dimension_programa">Dimensión del Programa:</label>
                        <select id="dimension_programa" name="dimension_programa" onchange="mostrarActividad()">
                    ...
                    <div id="colectivos" class="hidden" style="display: none;">
                        ...
                        <div class="form-group">
                            ...
                            <select id="acti" name="acti">
                                ...
                                <option value="acti4">Comprobación de recursos</option>
                                <option value="acti5">Otro</option>
                            </select>
                        </div>
                    </div>
                    <div id="usuarios" class="hidden" style="display: none;">
                        <h3>Usuarios</h3>
                        <div class="form-group">
                            <label for="servicio">Actividad</label>
                    ...
                    <div id="beneficiario" class="hidden" style="display: none;">
                        <h3>Beneficiario Directo</h3>
                        <div class="form-group">
                            <label for="beneficiario_servicio">Actividad:</label>
                            <select id="beneficiario_servicio" name="beneficiario_servicio">
                                <option value="">Seleccione un servicio</option>
                                <option value="salud">Visitas</option>
                                <option value="educacion">Talleres</option>
                                <option value="alimentacion">Asesorias</option>
                                <option value="otro">Comprobación de recursos</option>
